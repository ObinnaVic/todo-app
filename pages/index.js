...
export default function Home() {
  ...
  const HandleRemoveUndone = (id) => {
    dispatch({type: "REMOVE_UNDONE_ITEMS", payload: id})
  }

  const HandleRemove = (id) => {
    dispatch({ type: "REMOVE_DONE_ITEMS", payload: id });
  }
  
  return (
    <Layout title={"todo-list"}>
      <div className="flex flex-col justify-center items-center h-screen w-full bg-cyan-100">
        <h1 className="text-blue-900 font-bold text-4xl p-2">TO-DO</h1>
              ...
              return (
                <div className="flex justify-between items-center p-3 my-2 bg-blue-600">
                  ...
                  <div className="flex">
                    ...
                    <button onClick={() => HandleRemoveUndone(item.id)}>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="25"
                        height="25"
